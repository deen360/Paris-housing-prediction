...
filename = "models/linear-reg"
pickle.dump((dv, regressor_linear), open(filename, "wb"))

mlflow.log_artifact(local_path="models/linear-reg", artifact_path="_local_models_pickle")
