...
i = 1
input_file = (
    f"s3://mlops-project-dataset-deen/paris-housing-dataset/ParisHousing_period_{i:02d}.parquet"
)
...
mlflow.log_param(
    "train-data-path",
    "s3://mlops-project-dataset-deen/paris-housing-dataset/ParisHousing_period_01.parquet",
)

mlflow.log_param(
    "valid-data-path",
    "s3://mlops-project-dataset-deen/paris-housing-dataset/ParisHousing_period_02.parquet",
)
...
y_pred = regressor_lasso.predict(X_val)
...
filename = "models/lasso-reg"
pickle.dump((dv, regressor_lasso), open(filename, "wb"))

mlflow.log_artifact(local_path="models/lasso-reg", artifact_path="_local_models_pickle")
