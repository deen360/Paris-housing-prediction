...
def train_predict_model(dv, model, X_train, X_val, y_train, y_val):
    with mlflow.start_run():
        ...
        filename = "./models/prefect-model-lin.b"
...
@flow
def main(
    train_path: str = "s3://mlops-project-dataset-deen/paris-housing-dataset/ParisHousing_period_01.parquet",
    val_path: str = "s3://mlops-project-dataset-deen/paris-housing-dataset/ParisHousing_period_02.parquet",
):
